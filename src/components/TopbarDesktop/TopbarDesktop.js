...
const TopbarDesktop = props => {
  ...
  const profileMenu =
    ...
    (currentUser && currentUser.attributes.email === process.env.REACT_APP_REPORTS_EMAIL) ? (
      <Menu>
        ...
        <MenuContent className={css.profileMenuContent}>
          ...
          <MenuItem key="ReportsPage">
            <NamedLink
              className={classNames(css.yourListingsLink, currentPageClass('ReportsPage'))}
              name="ReportsPage"
            >
              <span className={css.menuItemBorder} />
              <FormattedMessage id="TopbarDesktop.reportsPageLink" />
            </NamedLink>
          </MenuItem>
          <MenuItem key="logout">
